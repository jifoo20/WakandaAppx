...
function constructor (id) {
	...
	{// @endlock
		...
		sources.ttclassroom.selectByKey(WAF.widgets.timeTableDetails_combobox1.getValue());
		sources.ttcourse.selectByKey(WAF.widgets.timeTableDetails_combobox2.getValue());
		sources.ttstudyGroup.selectByKey(WAF.widgets.timeTableDetails_combobox3.getValue());
		debugger;
	};// @lock
	function init_contournement()
		...
		setTimeout(init_contournement,5);
